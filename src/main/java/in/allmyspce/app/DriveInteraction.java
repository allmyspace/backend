...
class DriveInteraction {
    ...
    //     }
    //   }
    private static final String CLIENTSECRETS_LOCATION = "C:\\allmyspace\\client_secret_401774623329-rvk1u4cah07apenefeb865ab18522pp9.apps.googleusercontent.com.json";

    private static final String REDIRECT_URI = "localhost:8080/drive/login";
        ...
        if (flow == null) {
            ...
            GoogleClientSecrets clientSecrets =
                    GoogleClientSecrets.load(jsonFactory,
                            new InputStreamReader(DriveInteraction.class.getResourceAsStream(CLIENTSECRETS_LOCATION)));
            flow =
